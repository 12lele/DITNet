...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='/data1/lxl/ICAFusion/runs/train/exp3/weights/best.pt', help='model.pt path(s)')
    parser.add_argument('--data', type=str, default='./data/multispectral/kaist.yaml', help='*.data path')
    ...
    p = "/data1/kaist/KAIST/labels/test"
